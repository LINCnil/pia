...
| | |
| --- | --- |
| ![Logo](../assets/images/help/en/2018-02-23 01 Edit 02 - Remplir un champ.png) | Pour remplir un champ, cliquez sur le champ gris sous la question que vous souhaitez traiter. L'aide à la saisie présente précédemment dans le champ est reportée dans la colonne de la base de connaissances. Il vous est possible de mettre en forme le texte que vous insérez en utilisant la barre de mise en forme apparaissant sous le champ de saisi de texte. Pour éditer un champ dans lequel du texte est déjà saisi, cliquez sur ce texte. Le champ d'édition s'activera automatiquement. |
...
| | |
| --- | --- |
| ![Logo](../assets/images/help/en/2018-02-23 01 Edit 09 - Base de Connaissances - filter.png) | La base de connaissances contient les informations essentielles dont vous avez besoin pour réaliser votre analyse d'impact. Vous accompagnant tout au long de votre étude, elle est automatiquement filtrée en fonction de la section et de la question que vous traitez. Il est aussi possible de chercher manuellement au sein de la base de connaissances avec la barre de recherche associée. |
...
| | |
| --- | --- |
| ![Logo](../assets/images/help/en/2018-02-23 01 Edit 08 - Vue d_ensemble des risques.png) | La vue d'ensemble des risques vous offre une compréhension rapide des risques et des éléments les influençant. Vous pouvez filtrer la visualisation en cliquant sur les différents éléments, que ce soit un risque, les impacts, les menaces, les sources ou les mesures. |
 
## Evaluation du PIA

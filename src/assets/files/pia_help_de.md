...
| | |
| --- | --- |
| ![Logo](./assets/images/help/en/2018-02-23 01 Edit 01 - CrÇer PIA.png) | So erstellen Sie eine DSFA: <ul><li> Klicken Sie in der Kartenansicht auf das Plus ("+"), das mit "DSFA anlegen" auf der DSFA-Erstellungskarte verknüpft ist. Klicken Sie auf die Schaltfläche "Starten"; </li><li> Klicken Sie in der Listenansicht auf die Schaltfläche "DSFA anlegen". Klicken Sie auf die Schaltfläche "Starten". </li></ul> Sie müssen alle Felder ausfüllen, um die DSFA bearbeiten zu können. Die Informationen, die beim Erstellen einer DSFA eingegeben wurden, können jederzeit in der Übersicht bearbeitet werden. |

### Ein Textfeld bearbeiten

| | |
| --- | --- |
| ![Logo](./assets/images/help/en/2018-02-23 01 Edit 02 - Remplir un champ.png) | Um ein Textfeld zu füllen, klicken Sie auf den grauen Textbereich unter der Frage, die Sie beantworten möchten. Der Platzhaltertext, der zuvor in diesem Textbereich angezeigt wurde, wird automatisch in der Wissenbasis-Spalte angezeigt. Sie können den eingegebenen Text formatieren, indem Sie die Symbolleiste unter dem Textfeld verwenden. Um ein Feld zu bearbeiten, in dem bereits Text eingegeben wurde, klicken Sie auf diesen Text, um die Ausgabe des Textfelds zu aktivieren. |

### Kommentare hinzufügen

| | |
| --- | --- |
| ![Logo](./assets/images/help/en/2018-02-23 01 Edit 02 - Remplir un champ.png) | Um einen Kommentar hinzufügen, klicken Sie auf "Kommentieren" und geben Sie Ihren Kommentar in das Feld ein, das angezeigt wird. Klicken Sie anschließend auf "Senden", um ihn zu speichern. |

### Die Wissensbasis nutzen

| | |
| --- | --- |
| ![Logo](./assets/images/help/en/2018-02-23 01 Edit 09 - Base de Connaissances - filter.png) | Die Wissensbasis enthält die wesentlichen Informationen, die Sie für die Durchführung einer DSFA benötigen. Sie ist während der Bearbeitung einer DSFA jederzeit verfügbar und wird automatisch entsprechend der von Ihnen beantworteten Frage gefiltert. Sie können die Wissensbasis auch manuell über die zugehörige Suchleiste durchsuchen. |

### Anhänge hinzufügen

| | |
| --- | --- |
| ![Logo](./assets/images/help/en/2018-02-23 01 Edit 11 - Ajout de piäce-jointe.png) | Um einen Anhang hinzuzufügen, klicken Sie auf "Hinzufügen" unter den Anhängen, die unter dem Navigationsmenü auf der linken Seite angezeigt werden. |

### Maßnahmen hinzufügen

| | |
| --- | --- |
| ![Logo](./assets/images/help/en/2018-02-23 01 Edit 04 - Ajout de mesures.png) | Um eine Maßnahme hinzuzufügen, können Sie entweder: <ul><li> Manuell eine neue Maßnahme hinzufügen, indem Sie auf "Erstellen Sie eine Maßnahme ..." klicken oder</li><li> eine in der Wissensdatenbank verfügbare Maßnahme automatisch hinzufügen, indem Sie auf die dazugehörige Schaltfläche plus ("+") klicken. </li></ul> |

### Risiken bearbeiten

| | |
| --- | --- |
| ![Logo](./assets/images/help/en/2018-02-23 01 Edit 05 - Editer un risque - tag.png) ![Logo](./assets/images/help/en/2018-02-23 01 Edit 06 - Editer un risque -mesure.png) ![Logo](./assets/images/help/en/2018-02-23 01 Edit 07 - Editer un risque - jauge.png) | Um ein Risiko zu bearbeiten, müssen Sie im entsprechenden Feld jede Auswirkung, Bedrohung, Quelle und Maßnahme, die mit dem betrachteten Risiko verknüpft sind, als Tag eingeben. Als Maßnahmen können Sie nur diejenigen eingeben, die zuvor im Abschnitt "Geplante oder vorhandene Maßnahmen" gespeichert wurden. Wenn Sie eine neue Maßnahme hinzufügen möchten, sollten Sie dies im oben genannten Abschnitt tun. Um den Risikoschweregrad und die Eintrittswahrscheinlichkeit anzugeben, bewegen Sie den Zeiger auf der Skala auf die entsprechende geschätzte Ebene. Sie müssen diese Schätzung auch anhand der zuvor gemachten Angaben begründen. |

### Risikoübersicht

| | |
| --- | --- |
| ![Logo](./assets/images/help/en/2018-02-23 01 Edit 08 - Vue d_ensemble des risques.png) | Die Risikoübersicht ermöglicht Ihnen einen schnellen und einfachen Weg, die mit der Verarbeitung und den Einflussfaktoren verbundenen Risiken zu verstehen. Sie können die Visualisierung filtern, indem Sie auf die verschiedenen Kategorien (Auswirkung, Bedrohung, Quelle, Maßnahme) oder Risiken klicken. |

## DSFA bewerten

Zweiter Schritt der DSFA, die Evaluierung wird vom DSB gemeinsam mit dem CISO durchgeführt. Die Bewertung kann an einem ganzen Abschnitt oder an jeder Frage eines Abschnitts vorgenommen werden. Entweder sind zwei oder drei Bewertungsoptionen verfügbar.

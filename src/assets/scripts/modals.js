/* A conserver : permet d'afficher une modale au clic d'un élément (voir entry-content.html pour exemple) */
...
/**
 * Handles different modales on the PIA tool.
*/
var modalObject = (function () {
  return {
    modalDisplayer: function(e) {
      e = e || window.event;
      const target = e.target || e.srcElement;

  ...
  getCsv() {
    ...
    if (this.results && this.results.length > 0) {
      ...
      this.results.forEach(data => {
        if (
          data &&
          data.action_plan_comment &&
          data.action_plan_comment.length > 0
        ) {
          this.csvRows.push({
            blank: '',
            short_title: data.short_title
              ? this._translateService.instant(data.short_title)
              : '',
    ...
    if (this.risks['3.2']) {
      ...
      this.csvRows.push({
        ...
        action_plan_comment: this.filterText(
          this.risks['3.2'].action_plan_comment
        ),
        evaluation_comment: this.filterText(
          this.risks['3.2'].evaluation_comment
        ),
        evaluation_date: this.filterText(
    ...
    if (this.risks['3.3']) {
      ...
      this.csvRows.push({
        ...
        short_title: this._translateService.instant('action_plan.risk2'),
        action_plan_comment: this.filterText(
          this.risks['3.3'].action_plan_comment
        ),
        evaluation_comment: this.filterText(
          this.risks['3.3'].evaluation_comment
        ),
        evaluation_date: this.filterText(
    ...
    if (this.risks['3.4']) {
      ...
      this.csvRows.push({
        ...
        short_title: this._translateService.instant('action_plan.risk3'),
        action_plan_comment: this.filterText(
          this.risks['3.4'].action_plan_comment
        ),
        evaluation_comment: this.filterText(
          this.risks['3.4'].evaluation_comment
        ),
        evaluation_date: this.filterText(

              ...
              evaluation_date: this.filterText(
                this.formatTheDate
                  .transform(
                    ...
                    this._languagesService.selectedLanguage
                  )
                  .toString()
              ),
        ...
        evaluation2.getByReference(this.pia.id, referenceTo).then(() => {
          if (evaluation2.status > 0) {
            ...
            this.csvRows.push({
              ...
              evaluation_comment: this.filterText(
                evaluation2.evaluation_comment
              ),
              evaluation_date: this.filterText(
                this.formatTheDate
                  .transform(
                    evaluation2.estimated_implementation_date,
                    this._languagesService.selectedLanguage
                  )
                  .toString()
              ),
      ...
      if (evaluation3.status > 0) {
        ...
        this.csvRows.push({
          ...
          evaluation_date: this.filterText(
            this.formatTheDate
              .transform(
                evaluation3.estimated_implementation_date,
                this._languagesService.selectedLanguage
              )
              .toString()
          ),
      ...
      if (evaluation4.status > 0) {
        ...
        this.csvRows.push({
          ...
          evaluation_date: this.filterText(
            this.formatTheDate
              .transform(
                evaluation4.estimated_implementation_date,
                this._languagesService.selectedLanguage
              )
              .toString()
          ),
      ...
      if (evaluation5.status > 0) {
        ...
        this.csvRows.push({
          ...
          evaluation_date: this.filterText(
            this.formatTheDate
              .transform(
                evaluation5.estimated_implementation_date,
                this._languagesService.selectedLanguage
              )
              .toString()
          ),

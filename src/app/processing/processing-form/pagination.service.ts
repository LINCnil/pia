...
export class PaginationService {
  ...
  setPagination(sectionId: number, itemId: number) {
    ...
    //  !(sectionId === 4 && itemId === 4) && 
    //  !(sectionId === 4 && itemId === 5)
    // ;
    ...
    //     this.previousLink.push(this.dataNav[sectionId - 1]['items'][itemId - 2].title);
    //   } else { // 2.x, 3.x, 4.x
    ...
    //       this.previousLink.push(this.dataNav[sectionId - 1]['items'][itemId - 2].title); // Prev item title
    //     } else {  // 2.1, 3.1, 4.1
    //       this.previousLink.push(sectionId - 1); // Prev section id
    //       const previousSectionLength = this.dataNav[sectionId - 2]['items'].length;
    //       const lastPreviousItem = this.dataNav[sectionId - 2]['items'][previousSectionLength - 1];
    ...
    // }
    // if (this.hasNextLink) {
    //   const currentSectionLength = this.dataNav[sectionId - 1]['items'].length;
    //   const currentSectionLastItemId = this.dataNav[sectionId - 1]['items'][currentSectionLength - 1].id;
    ...
    //     this.nextLink.push(this.dataNav[sectionId - 1]['items'][itemId].title);  // Next item title
    //   } else {  // last item from the current section
    //     this.nextLink.push(sectionId + 1); // Next section id
    //     const firstNextItem = this.dataNav[sectionId]['items'][0];
